...
public class OrderStatusTransaction extends BaseTransaction {
    ...
    public OrderStatusTransaction(final Connection conn, final String[] params) {
        super(conn, params);
    ...
    public void execute() {
        try {
            ...
            if (orderID == -1) {
                System.out.println(String.format(QUERY_GET_LAST_ORDER, this.warehouseID, this.districtID, this.customerID));
