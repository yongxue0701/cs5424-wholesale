...
public class DataProcessor {
    ...
    public void loadData() {
        ...
        this.session.execute(getOrderWithoutNull(basePath));
        System.out.println("loaded orders without null value");
    ...
    private String getOrderByTimestampQuery(String basePath) {
        String query = "USE wholesale;\n COPY Orders_by_timestamp (O_W_ID, O_D_ID, O_ID, O_C_ID, O_CARRIER_ID, " +
                "O_OL_CNT, O_ALL_LOCAL, O_ENTRY_D) " +
                "FROM '%s/data/order.csv' " +
                "WITH DELIMITER = ',' AND NULL = 'null';";
        return String.format(query, basePath);
    ...
    private String getOrderWithoutNull(String basePath) {
        String query = "USE wholesale;\n COPY orders (O_W_ID, O_D_ID, O_ID,O_CARRIER_ID) " +
                "FROM '%s/data/carrier.csv' " +
                "WITH DELIMITER = ',';";
        return String.format(query, basePath);
    }
